...
describe('User Checkout', function() {
  ...
  it('can check out', function(done) {
    ...
    console.log('can check out url: ' + url);
      ...
      user.save(function(error) {
        ...
        superagent.
          ...
          send({
            ...
            console.log('Test, checkout returned error: ', error);
            assert.ifError(error);
